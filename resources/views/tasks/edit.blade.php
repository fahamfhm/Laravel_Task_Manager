        ...
        <div class="max-w-3xl mx-auto bg-white shadow-sm rounded-lg p-6">
            <form action="{{ route('tasks.update', $task) }}" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="task_name" value="{{ old('task_name', $task->task_name) }}" class="w-full mt-1 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
                ...
                <div class="mb-4">
                    ...
                    <textarea name="description" class="w-full mt-1 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500">{{ old('description', $task->description) }}</textarea>
                ...
                <div class="mb-4">
                    ...
                    <input type="date" name="deadline" value="{{ old('deadline', $task->deadline) }}" class="w-full mt-1 border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500" required>
