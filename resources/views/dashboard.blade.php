        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-gray-500 dark:text-gray-400 text-sm font-medium">Total Tasks</h3>
                    <p class="text-3xl font-bold text-indigo-600 dark:text-indigo-400">{{ $totalTasks ?? 0 }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-gray-500 dark:text-gray-400 text-sm font-medium">Completed Tasks</h3>
                    <p class="text-3xl font-bold text-green-600 dark:text-green-400">{{ $completedTasks ?? 0 }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-gray-500 dark:text-gray-400 text-sm font-medium">Pending Tasks</h3>
                    <p class="text-3xl font-bold text-yellow-500 dark:text-yellow-400">{{ $pendingTasks ?? 0 }}</p>
                </div>
                <div class="bg-white dark:bg-gray-800 p-6 rounded-xl shadow hover:shadow-lg transition">
                    <h3 class="text-gray-500 dark:text-gray-400 text-sm font-medium">Categories</h3>
                    <p class="text-3xl font-bold text-purple-600 dark:text-purple-400">{{ $totalCategories ?? 0 }}</p>
                </div>
            </div>
